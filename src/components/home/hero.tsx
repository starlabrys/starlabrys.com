...
export default function Hero({ hero }: { hero: HomeContent["hero"] }) {
  ...
  return (
    <section className="relative overflow-hidden pt-[calc(4.25rem+2.5rem)] pb-12 text-home-white sm:pb-16">
      ...
      {hero.image ? (
        <div className="relative z-10 mx-auto mt-10 w-[min(1280px,calc(100%-1.25rem))] sm:mt-12 sm:w-[min(1280px,calc(100%-2rem))] lg:mt-14 lg:w-[min(1280px,calc(100%-3rem))]">
          <Reveal delay={1}>
            <div className="overflow-hidden rounded-sm border border-white/15 bg-home-ink/40 shadow-[0_28px_70px_rgba(0,0,0,0.4)]">
              <Image
                src={hero.image}
                alt=""
                width={1914}
